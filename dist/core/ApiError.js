...
exports.AccessTokenError = exports.NoDataError = exports.TokenExpiredError = exports.BadTokenError = exports.NoEntryError = exports.ForbiddenError = exports.NotFoundError = exports.NoDataCusError = exports.BadRequestError = exports.InternalError = exports.AuthFailureError = exports.ApiError = void 0;
const fs = require('fs');
...
(function (ErrorType) {
    ...
    ErrorType["NO_DATA_REQUEST"] = "NoDataCusError";
})(ErrorType || (ErrorType = {}));
class ApiError extends Error {
    ...
    static handle(err, res) {
        let errData = "---------------------------------------------------------------------------------------------\n";
        errData += "Time : " + (0, moment_1.default)().format('YYYY-MM-DD HH:mm:ss') + "\n";
        ...
        errData += "---------------------------------------------------------------------------------------------\n";
        fs.appendFileSync('ErrorLogs/' + (0, moment_1.default)(new Date()).format('DD-MM-YYYY') + '.txt', '\n' + errData);
        switch (err.type) {
            ...
            case ErrorType.NO_DATA_REQUEST:
                return new ApiResponse_1.NotFoundCusResponse(err.message).send(res);
            default: {
...
class NoDataCusError extends ApiError {
    constructor(message = 'Data not found') {
        super(ErrorType.NO_DATA_REQUEST, message);
    }
}
exports.NoDataCusError = NoDataCusError;
