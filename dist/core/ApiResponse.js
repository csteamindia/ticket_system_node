...
exports.TokenRefreshResponse = exports.AccessTokenErrorResponse = exports.FailureResponse = exports.SuccessResponse = exports.FailureMsgResponse = exports.SuccessMsgResponse = exports.InternalErrorResponse = exports.NotFoundCusResponse = exports.BadRequestResponse = exports.ForbiddenResponse = exports.NotFoundResponse = exports.AuthFailureResponse = void 0;
const { dbWriter } = require('../db');
// Helper code for the API consumer to understand the error and handle is accordingly
var StatusCode;
(function (StatusCode) {
    StatusCode[StatusCode["SUCCESS"] = 200] = "SUCCESS";
    StatusCode[StatusCode["NO_DATA_REQUEST"] = 201] = "NO_DATA_REQUEST";
...
(function (ResponseStatus) {
    ...
    ResponseStatus[ResponseStatus["NO_DATA_REQUEST"] = 201] = "NO_DATA_REQUEST";
...
class NotFoundCusResponse extends ApiResponse {
    constructor(message = 'Data not found') {
        super(StatusCode.NO_DATA_REQUEST, ResponseStatus.NO_DATA_REQUEST, message);
    }
}
